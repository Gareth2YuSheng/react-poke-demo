...
export default function PokemonInfo() {
    ...
    return (
        <div style={{paddingLeft: "60px", paddingTop: "20px"}}>
            ...
            {pokemonInfo.sprites.other["official-artwork"].front_default && <img className="artwork" src={pokemonInfo.sprites.other["official-artwork"].front_default} />}
            <br/>
            <h3>Sprites</h3>
            <div style={{display:'flex'}}>    
                <div className="male">
                    {pokemonInfo.sprites.front_female && <h4 className="gender">Male</h4>}
                    {pokemonInfo.sprites.front_default && <img className="sprite" src={pokemonInfo.sprites.front_default} alt={pokemonInfo.name+" back"} />}
                ...
                {pokemonInfo.sprites.front_female && <div className="female">
                    ...
                    {pokemonInfo.sprites.front_female && <img className="sprite" src={pokemonInfo.sprites.front_female} alt={pokemonInfo.name+" back"} />}
